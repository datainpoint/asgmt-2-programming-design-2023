...
class TestAssignmentTwo(unittest.TestCase):
    ...
    def test_02_is_upper_or_lower_cased(self):
    ...
    def test_03_reverse_vowel(self):
        ...
        self.assertEqual(asgmt.reverse_vowel("I"), 'i')
    def test_04_convert_temperature_degrees_to_different_scales(self):
        self.assertGreaterEqual(asgmt.convert_temperature_degrees_to_different_scales(0, "Celsius", "Fahrenheit"), 32.0)
        self.assertGreaterEqual(asgmt.convert_temperature_degrees_to_different_scales(100, "Celsius", "Fahrenheit"), 212.0)
        self.assertGreaterEqual(asgmt.convert_temperature_degrees_to_different_scales(32, "Fahrenheit", "Celsius"), 0.0)
        self.assertGreaterEqual(asgmt.convert_temperature_degrees_to_different_scales(212, "Fahrenheit", "Celsius"), 100.0)
        self.assertGreaterEqual(asgmt.convert_temperature_degrees_to_different_scales(0, "Celsius", "Kelvin"), 273.15)
        self.assertGreaterEqual(asgmt.convert_temperature_degrees_to_different_scales(100, "Celsius", "Kelvin"), 373.15)
        self.assertGreaterEqual(asgmt.convert_temperature_degrees_to_different_scales(32, "Fahrenheit", "Kelvin"), 273.15)
        self.assertGreaterEqual(asgmt.convert_temperature_degrees_to_different_scales(212, "Fahrenheit", "Kelvin"), 373.15)
